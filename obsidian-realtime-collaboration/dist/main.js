 ...
 */
class WebrtcProvider extends ObservableV2 {
  /**
   * @param {string} roomName
   * @param {Y.Doc} doc
...
class CollaborativePlugin extends obsidian.Plugin {
    yjsManager;
    p2pProvider;
    editorBinding;
    userAwareness;
...
module.exports = CollaborativePlugin;
